...
`;
    ...
    class Advection extends ShaderPass {
      ...
      updateService({ dt, isBounce, BFECC }: any) {
    ...
    class ExternalForce extends ShaderPass {
      ...
      updateService(props: any) {
        ...
        uniforms.uniforms.force.value.set(forceX, forceY);
        uniforms.uniforms.center.value.set(centerX, centerY);
        uniforms.uniforms.scale.value.set(props.cursor_size, props.cursor_size);
        super.update();
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      updateService({ viscous, iterations, dt }: any) {
    ...
    class Pressure extends ShaderPass {
      ...
      updateService({ vel, pressure }: any) {
        this.uniforms.velocity.value = vel.texture;
    ...
    class Simulation {
      ...
      update() {
        ...
        this.advection!.updateService({
          dt: this.options.dt,
          isBounce: this.options.isBounce,
          BFECC: this.options.BFECC,
        });
        this.externalForce!.updateService({
          cursor_size: this.options.cursor_size,
        ...
        if (this.options.isViscous) {
          vel = this.viscous!.updateService({
            viscous: this.options.viscous,
            iterations: this.options.iterations_viscous,
            dt: this.options.dt,
          });
        }
        this.divergence!.updateService({ vel });
        const pressure = this.poisson!.updateService({
          iterations: this.options.iterations_poisson,
        });
        this.pressure!.updateService({ vel, pressure });
      }
    }
      ...
      dispose() {
        try {
          ...
          if (Common.renderer) {
            ...
            (Common.renderer as any).forceContextLoss();
          }
        } catch (e) {
          void 0;
        }
